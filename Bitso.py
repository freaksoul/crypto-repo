...
# Ejemplo: Compra 0.001 BTC si el precio está por debajo de $600,000 MXN
...
if price < 600000:
    place_order('btc_mxn', 'buy', 0.001, price)
    print("¡Orden enviada!")
else:
