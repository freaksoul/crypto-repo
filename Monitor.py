...
# Configuración
CSV_PRECIOS = "C:\\Viboron\\tusd_precios.csv"
LOG_FILE = "C:\\Viboron\\tusd_decisiones.csv"
...
def evaluar():
    price = get_btc_price()
    print(f"📈 Precio actual TUSD: ${price:,.0f} MXN")
...
def graficar_historial():
    ...
    plt.plot(df_log["Fecha"], df_log["Precio"], label="Precio TUSD", marker='o')
    ...
    plt.title("Historial de precios y decisiones TUSD")
    plt.xlabel("Fecha")
